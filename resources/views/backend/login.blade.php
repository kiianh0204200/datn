        ...
        <section class="content-main mt-80 mb-80">
            <div class="card mx-auto card-login">
                <div class="card-body">
                    ...
                    <form action="{{route('auth.login.store')}}" method="post" id="formLogin">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <label class="form-check">
                                <input type="checkbox" name="remember_token" id="remember" class="form-check-input" onclick="setValue()" value="0">
                    ...
                    <p class="text-center mb-4">Don't have account? <a href="{{route('auth.register')}}">Sign up</a></p>
                </div>
            </div>
        </section>
