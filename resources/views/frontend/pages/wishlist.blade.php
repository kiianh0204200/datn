                    ...
                    <div class="table-responsive">
                        <table class="table shopping-summery text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="image"><img src="{{ asset('frontend/assets/imgs/shop/product-2-1.jpg') }}" alt="#"></td>
                                ...
                                <tr>
                                    <td class="image"><img src="{{ asset('frontend/assets/imgs/shop/product-3-1.jpg') }}" alt="#"></td>
                                    <td class="product-des">
